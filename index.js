...
const {generateDbContent} = require('./db/dbContent');
const {generatePopulateDbContent} = require('./db/populateDB');
...
const {generateUserModelContent} = require('./db/userModelContent');
const {generateDbUserContent} = require('./db/dbUserContent');
const {generateRoutesIndexContent} = require('./routes/routesIndexContent');
const {generateRoutesUsersContent} = require('./routes/routesUsersContent');
const {generateMiddlewareAuthContent} = require('./middleware/middlewareAuthContent');
const {generateMiddlewareUsersContent} = require('./middleware/middlewareUsersContent');
const {generatePrismaClientContent} = require('./db/prismaClientContent');
const {generatePrismaUser} = require('./db/prismaUserContent');
const {generatePrismaUserModel} = require('./db/prismaUserModel');
